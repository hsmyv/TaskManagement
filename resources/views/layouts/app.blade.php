...
<div class="flex h-full">
    ...
    <div class="flex-1 flex flex-col min-h-screen overflow-hidden">
        ...
        <header class="bg-white border-b border-slate-200 px-6 py-3 flex items-center justify-between sticky top-0 z-40">
            ...
            <div class="flex items-center gap-3">
                {{-- Bildirişlər — hər 30 saniyə polling --}}
                            ...
                            <template x-for="n in notifications" :key="n.id">
                                <div @click="markRead(n)"
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <p class="text-sm text-slate-700" x-text="n.data?.task_title"></p>
...
// Bildiriş bell — hər 30 saniyə server-ə soruşur
    ...
    return {
        ...
        async fetchUnreadCount() {
            try {
                ...
                // Yeni bildiriş gəlibsə toast göstər
